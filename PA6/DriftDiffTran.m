...
% Simulation = 'Gau_2_car_0';
Simulation = 'PNJnctBC_Bias';
...
elseif strcmp(Simulation, 'Gau_2_car_0')
    eval('SetGaussian_two_carriers_0');
elseif strcmp(Simulation, 'PNJnctBC_Bias')
    eval('Setpn_jnc_eqBCBias');
end
